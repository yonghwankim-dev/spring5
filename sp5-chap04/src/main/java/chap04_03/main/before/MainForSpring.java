...
import chap04_03.config.before.AppCtx;

/**
 * 본 예제의 목적은 스프링 설정 클래스(AppCtx.java)에서 
 * 같은 클래스 타입의 빈 설정 메소드가 2개 이상 존재하는 경우
 * NoUniqueBeanDefinitionException 예외 발생을 확인하는 예제이다.
 * 
 * config.before.AppCtx.java 내용 확인
 * 
 * 실행 결과
 * NoUniqueBeanDefinitionException 예외 유발
 */
